...
Contra más proporción de tests se realizan, más  proporción de casos detectamos. Hay una correlación de Spearman del 0.72 con un p-valor estadísticametne significativo.
