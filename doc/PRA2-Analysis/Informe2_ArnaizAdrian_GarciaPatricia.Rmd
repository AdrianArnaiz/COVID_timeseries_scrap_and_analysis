...
## Contexto
En el contexto de obtención del dataset explicado en la anterior práctica, nos gustaría realizar un análisis de varios aspectos de la pandemia por **Covid-19**. En este contexto es importante analizar con rigor diferentes aspectos de la pandemia, para dar lugar a consluiones basaddas en esos análisis. 
...
![Representación gráfica \label{alternativas_csv}](./PRA2-Analysis/img/alternativas.png)
...
![Pasos de la integración y selección \label{fig:pasosetl}](./PRA2-Analysys/img/pasosetl.png)
